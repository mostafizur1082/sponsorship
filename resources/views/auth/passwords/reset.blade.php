                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="email" id="fullname" placeholder="Enter your name" name="email" value="{{old('email')}}" required>
                                        @error('email')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('password') is-invalid @enderror" type="email" id="password" name="password" value="{{old('password')}}"required placeholder="Enter your email">
                                        @error('password')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
